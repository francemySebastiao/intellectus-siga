...
public class Pagamentos {
    ...
    private String accounting_period_end;
    private String accounting_period_start;
	...
	public String getAccounting_period_end() {
		return accounting_period_end;
	}
	public void setAccounting_period_end(String accounting_period_end) {
		this.accounting_period_end = accounting_period_end;
	}
	public String getAccounting_period_start() {
		return accounting_period_start;
	}
	public void setAccounting_period_start(String accounting_period_start) {
