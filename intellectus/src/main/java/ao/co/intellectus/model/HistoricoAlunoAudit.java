...
@Entity
@Table(name = "t_historico_aluno_audit")
public class HistoricoAlunoAudit {
	@Id
	@GeneratedValue
	private Integer id;
	...
	private MatriculaAudit matriculaAudit;
	@ManyToOne
	...
	public MatriculaAudit getMatriculaAudit() {
		return matriculaAudit;
	}

	public void setMatriculaAudit(MatriculaAudit matriculaAudit) {
		this.matriculaAudit = matriculaAudit;
	}
