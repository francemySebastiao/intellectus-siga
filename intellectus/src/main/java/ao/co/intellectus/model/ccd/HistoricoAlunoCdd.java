package ao.co.intellectus.model.ccd;
...
@Entity
@Table(name = "t_historico_aluno_ccd")
public class HistoricoAlunoCdd {
	@Id
	@GeneratedValue
	private Integer id;
	...
	private MatriculaCcd matriculaCcd;
	@ManyToOne
	...
	public MatriculaCcd getMatriculaCcd() {
		return matriculaCcd;
	}

	public void setMatriculaCcd(MatriculaCcd matriculaCcd) {
		this.matriculaCcd = matriculaCcd;
	}
